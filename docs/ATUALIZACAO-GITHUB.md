...
Publique no GitHub Releases o arquivo `latest.json` produzido em `Release/vX.Y.Z/`. Para a v0.2.0, o manifesto é:

```json
{
  "applicationId": "com.mllopesdesign.celcfinanceiro",
  "version": "0.2.0",
  "resourcesURL": "https://github.com/mlopesdesign/celc-financeiro/releases/download/v0.2.0/resources.neu"
}
```
